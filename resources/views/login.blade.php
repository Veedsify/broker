                            ...
                            <div class="collapse navbar-collapse justify-content-between" id="navbar-content">
                                <ul
                                    ...
                                    <li class="dropdown show-dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item fs-ten" href="ido.html">IDO</a></li>
                                            <li><a class="dropdown-item fs-ten" href="idodetails.html">IDO Details</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="dropdown show-dropdown">
                                        <button type="button" aria-label="Navbar Dropdown Button"
                                            ...
                                            <i class="ti ti-chevron-down"></i></button>
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item fs-ten" href="swap.html">Swap</a></li>
                                            <li><a class="dropdown-item fs-ten" href="swap-checkout.html">Swap to
                                                    share</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown show-dropdown">
                                    ...
                                    <li class="dropdown show-dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item fs-ten" href="buycrypto.html">Buy Crypto</a>
                                            </li>
                                            <li><a class="dropdown-item fs-ten" href="pricing-plan.html">Pricing
                                                    plan</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown show-dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item fs-ten" href="blogdetails.html">Blog
                                                    details</a>
                                            </li>
                    ...
                    <div class="modal-content bg7-color rounded-20 p-3 p-sm-4 p-md-6">
                        ...
                        <div class="modal-body">
                            <div class="apex_section__aside-logintop d-flex align-items-center gap-3">
                                <span>New to Bybit?</span> <i class="ti ti-arrows-exchange-2 fs-four p1-color"></i>
                                <a href="sign-up.html" class="d-flex align-items-center gap-3 p1-color">Sign up
                                </a>
                            </div>
                            <div class="apex_section__aside-tabs mt-4">
                                ...
                                <div class="d-flex align-items-center gap-5 gap-md-6 mb-3">
                                    ...
                                    <a class="cmn-btn w-100 py-3 px-5 px-md-6 d-center gap-2 fourth-alt"
                                        href="javascript:void(0)">
                                        <img src="/assets/images/icon/apple-icon.png" alt="icons">Google</a>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer d-center">
                            <!-- <button class="d-flex align-items-center gap-3 p1-color" data-bs-target="#exampleModalToggle2"
                                                data-bs-toggle="modal">Log in with Subaccount
                                                <i class="ti ti-arrow-right fs-four p1-color"></i>
                                            </button> -->
                            <a href="javascript:void(0)" class="d-flex align-items-center gap-3 p1-color">Log in
                                with
                                Subaccount
                                <i class="ti ti-arrow-right fs-four p1-color"></i>
                            </a>
