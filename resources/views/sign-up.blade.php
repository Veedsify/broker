            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-5 col-xxl-5">
                    <div class="navbar_top__left d-flex align-items-center gap-2 gap-xl-6">
                        ...
                        <a href="/cdn-cgi/l/email-protection#9ffae7fef2eff3fadff8f2fef6f3b1fcf0f2"
                            class="navbar_top__email roboto p7-color d-flex align-items-center gap-3">
                            <i class="ti ti-mail-opened-filled fs-four"></i>
                            <span class="__cf_email__"
                                data-cfemail="bfdac7ded2cfd3daffd8d2ded6d391dcd0d2">[email&#160;protected]</span></a>
                    </div>
                </div>
                    ...
                    <div class="modal-content bg7-color rounded-20 p-3 p-sm-4 p-md-6">
                        ...
                        <div class="modal-body">
                            <div class="apex_section__aside-logintop d-flex align-items-center gap-3 flex-wrap">
                                ...
                                <a href="login.html" class="d-flex align-items-center gap-3 p1-color">Log In
                                </a>
                            </div>
