 <div>
     <div id="confirmModal"
         class="fixed bg-lime-950 bg-opacity-50 z-30 inset-0 w-full h-full flex duration-300  items-center justify-center">
         <div class="bg-bgprimary p-7 rounded-md m-4 w-[300px]" id="inner_content">
             <div class="">
                 <div class="block">
                             ...
                             <div class="grid grid-cols-12 gap-4">
                                 <div class="col-span-12">
                                     <label for="proof_of_payment"
                                         class="text-white cursor-pointer select-none inline-block mb-3 font-bold">Upload
                                         Proof Of Payment
                                         <input required type="file" id="proof_of_payment" name="proof"
                                             class="hidden border-gray-100 px-3 w-full mb-4 rounded-md">
                                         <div class="border border-bgborder rounded-md mt-3">
                                 ...
                                 <div class="col-span-12">
                                     <input type="submit" value="Confirm Payment"
                                         class="bg-lime-500 cursor-pointer text-white py-3 font-bold px-3 block w-full mb-4 rounded-md">
                                 </div>
                             </div>
                         </form>
                     </div>
