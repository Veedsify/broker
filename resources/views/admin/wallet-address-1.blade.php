                ...
                <div>
                    <div class="  card ">
                        <div class=" px-4 card-body pb-1 ">
                            <div>
                                <h6 class="text-gray-600 text-15 whitespace-nowrap ">Recent Deposit</h6>
                                <p class="text-gray-400 py-2">Transaction History shows information about cash deposits for
                                    your admin.</p>
                            </div>
                        </div>
                        <div>
