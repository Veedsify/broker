...
@section('content')
    ...
    <div class="hidden">
        ...
        <div class="fixed right-0 z-50 h-screen bg-bgprimary w-80" data-simplebar="">
                            ...
                            <ol class="inline-flex items-center space-x-1 ltr:md:space-x-3 rtl:md:space-x-0">
                                ...
                                <li>
                                    <div class="flex items-center rtl:mr-2">
                                        ...
                                        <a href="#"
                                            class="text-sm font-medium text-gray-50 ltr:ml-2 rtl:mr-2 hover:text-gray-900 ltr:md:ml-2 rtl:md:mr-2 ">Earning</a>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                ...
                <div>
                    <div class="  card ">
                        <div class=" px-4 card-body pb-1 ">
                            <div>
                                <h6 class="text-white text-15 whitespace-nowrap ">Transactions
                                    History
                                </h6>
                                <p class="text-gray-50 py-2">Transaction History shows information about cash deposits,
                                    cash withdrawals for your admin.</p>
                            </div>
                        </div>
                        <div>
