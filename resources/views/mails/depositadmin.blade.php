                                        ...
                                        <table width="100%" border="0" align="center" cellpadding="0"
                                            ...
                                            <tr>
                                                <td align="left" valign="top"
                                                    ...
                                                    mc:edit="bm11-05">
                                                    <multiline>Hello Admin,</multiline>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="left" valign="top"
                                                    ...
                                                    mc:edit="bm11-02">
                                                    <multiline>New Crypto Deposit from
                                                        {{ explode(' ', $user->name)[0] }}</multiline>
                                                </td>
                                            </tr>
                                            <tr>
                                                                ...
                                                                <table width="490" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" valign="top"
                                                                            ...
                                                                            <multiline>
                                                                                Hi Admin, <br>
                                                                                A new deposit has been made by
                                                                                {{ explode(' ', $user->name)[0] }}.
                                                                                <br>
                                                                                Please check the admin dashboard for
                                                                                more details and
                                                                                confirm the deposit. <br>
                                                                                <br>
                                                                                <b>Amount:</b>
                                                                                ${{ number_format($transactionHistory->amount) }}
                                                                                <br>
                                                                                <b>Deposit Method:</b> Bitcoin <br>
                                                                                <b>Deposit Date:</b>
                                                                                {{ $transactionHistory->created_at->format('d M, Y') }}
                                                                                <br>
                                                                                <b>Deposit Time:</b>
                                                                                {{ $transactionHistory->created_at->format('H:i:s') }}
                                                                                <br>
                                                                                <br>
                                                                            </multiline>
                                                                        </td>
