                        ...
                        <nav class="flex" aria-label="Breadcrumb">
                            <ol class="inline-flex items-center space-x-1 ltr:md:space-x-3 rtl:md:space-x-0">
                                <li class="inline-flex items-center">
                                    <a href="#" class="inline-flex items-center text-sm text-gray-50 ">
                                        Withdraw
                                    </a>
                                </li>
                                <li>
                                    <div class="flex items-center rtl:mr-2 text-gray-50">
                                        <i
                                            class="font-semibold text-gray-100 align-middle far fa-angle-right text-13 rtl:rotate-180 "></i>
                                        <a href="#"
                                            class="text-sm font-medium text-gray-50 ltr:ml-2 rtl:mr-2 ">History</a>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div class="  card ">
                        <div class=" px-4 card-body pb-1 ">
                            <div>
                                <h6 class="text-gray-50 text-15 whitespace-nowrap ">Recent Withdrawal
                                </h6>
                                <p class="text-gray-50 py-2">Your Withdrawal History provides details on recent cash
                                    transactions made from your account on the website.</p>
                            </div>
                        </div>
                        <div>
