                            ...
                            <ol class="inline-flex items-center space-x-1 ltr:md:space-x-3 rtl:md:space-x-0">
                                ...
                                <li>
                                    <div class="flex items-center rtl:mr-2">
                                        ...
                                        <a href="#"
                                            class="text-sm font-medium text-gray-500 ltr:ml-2 rtl:mr-2 hover:text-gray-900 ltr:md:ml-2 rtl:md:mr-2 ">Earnings</a>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                ...
                <div>
                    <div class="  card ">
                        <div class=" px-4 card-body pb-1 ">
                            <div>
                                <h6 class="text-gray-600 text-15 whitespace-nowrap ">Your Earnings</h6>
                                <p class="text-gray-400 py-2">Your Earnings History displays information regarding cash
