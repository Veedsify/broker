                            ...
                            <ol class="inline-flex items-center space-x-1 ltr:md:space-x-3 rtl:md:space-x-0">
                                ...
                                <li>
                                    <div class="flex items-center rtl:mr-2">
                                        ...
                                        <a href="#"
                                            class="text-sm font-medium text-gray-500 ltr:ml-2 rtl:mr-2 hover:text-gray-900 ltr:md:ml-2 rtl:md:mr-2">Order</a>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                ...
                <div class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <div class="flex items-center mb-4">
                        <div class="w-12 h-12 bg-yellow-50 rounded-full flex items-center justify-center mr-4">
                            <i class="text-gray-600 text-2xl fas fa-coins"></i>
                        </div>
                        <div>
                            <h3 class="text-lg font-semibold">Bitcoin Address</h3>
                            <p class="text-gray-600">1AbCDeFgHiJkLmNoPqRsTuVwXyZ</p>
                        </div>
                    </div>

                    <div class="flex items-center mb-4">
                        <div class="w-12 h-12 bg-green-50 rounded-full flex items-center justify-center mr-4">
                            <i class="text-gray-600 text-2xl fas fa-dollar-sign"></i>
                        </div>
                        <div>
                            <h3 class="text-lg font-semibold">Amount</h3>
                            <p class="text-gray-600">${{ number_format($transaction->amount) }}</p>
                        </div>
                    </div>

                    <div class="flex items-center mb-4">
                        <div class="w-12 h-12 bg-blue-50 rounded-full flex items-center justify-center mr-4">
                            <i class="text-gray-600 text-2xl fas fa-calendar-check"></i>
                        </div>
                        <div>
