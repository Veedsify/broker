...
document.addEventListener("DOMContentLoaded", function () {
    $(function ($) {
        ...
        $(".header-area").click(function () {
            ...
            if (
                accsingleElement.css("background-color") ===
                "rgba(255, 255, 255, 0.08)"
            ) {
                accsingleElement.css("background-color", "#BCE70C");
            } else {
                accsingleElement.css(
                    "background-color",
                    "rgba(255, 255, 255, 0.08)"
                );
            }
        ...
        $(document).click(function (event) {
            if (
                ...
                $(".common_area, .common_area2, .common_area3").removeClass(
                    "show"
                );
            }
        });
        ...
        // header-switch clone
        var switchContent = $(
            ".header-section .navbar-custom .right-area"
        ).html();
